...
class ModelTrainer:
    ...
    def __init__(self, df, target_col):
        ...
        self.task_type = 'classification' if self.y.dtype == 'object' or len(self.y.unique()) < 20 else 'regression'
    ...
    def get_best_model(self, results, metric='accuracy'):
        ...
        if best_model_name:
            return {
                ...
                'metric': metric,
                'full_results': {name: res.get('metrics', {}) for name, res in results.items() if 'metrics' in res}
            }
        return None
